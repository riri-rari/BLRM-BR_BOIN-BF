...
After having called the BOINBF() function, the BOIN::select.mtd() function is used to compute the MTD. Examples are provided in the BOINBF.R (Examples are taken from Table 3 of 'Backfilling Patients in Phase I Dose Escalation Trials Using Bayesina Optimal Interval Design (BON)').
