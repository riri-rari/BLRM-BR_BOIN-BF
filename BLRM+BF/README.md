...
$(\beta_0, \log(\beta_1) ) \sim N((\log(0.5), 0), (4, 0, 0, 1))$ (ref BLRM+BF paper). 
...
The backfill doses are also checked to close all those above the next dose and to evetually open all those below the next dose (unless a code for enough patients or not activity is present. See Appendix 2). \\
