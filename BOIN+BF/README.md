...
- the decision is to 'STAY' so the current dose is checked for the n\_stop. Eventually the n_stop_reached counter is updated and the while loop is stopped as well as the trial
